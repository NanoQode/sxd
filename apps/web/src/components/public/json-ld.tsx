...
export function organizationJsonLd(input: { name: string; url: string; description: string }): JsonLd {
  return {
  ...
  switch (pkg.priceBasis) {
    ...
    case 'from':
      return {
        '@type': 'Offer',
        priceCurrency: 'NGN',
        priceSpecification: { '@type': 'PriceSpecification', minPrice: price, priceCurrency: 'NGN' },
      };
    case 'per_month':
      return {
        '@type': 'Offer',
