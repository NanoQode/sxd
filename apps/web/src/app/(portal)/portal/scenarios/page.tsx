        ...
        <DataTable
          ...
          columns={[
            ...
            { key: 'objective', header: 'Objective', cell: (s) => humanize(s.objective) },
            {
              ...
              header: 'Mode',
              cell: (s) => (
                <Badge tone={s.mode === 'evidence' ? 'info' : 'gold'}>
                  {s.mode === 'evidence' ? 'Evidence' : 'Assumptions'}
                </Badge>
              ),
            },
            {
            ...
            { key: 'updated', header: 'Updated', cell: (s) => formatDateLabel(s.updatedAt, zone) },
            {
              ...
              cell: (s) =>
                s.convertedServiceRequestId ? (
                  <Link
                    href={`/portal/requests/${s.convertedServiceRequestId}`}
                  ...
                  <Link
                    href={`/portal/requests/new?scenario=${s.id}`}
                    className="text-primary underline"
                  >
