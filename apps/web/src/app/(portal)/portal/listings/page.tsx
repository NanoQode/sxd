  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          canManage ? <LinkButton href="/portal/listings/new">Create a listing</LinkButton> : null
        }
      />
      <SectionTabs
        ...
        tabs={[
          {
            ...
            label: 'Our listings',
            badge:
              listings.length > 0 ? <Badge tone="neutral">{listings.length}</Badge> : undefined,
          },
          {
            value: 'offers',
            label: 'Offers',
            badge: yourMove > 0 ? <Badge tone="warning">{yourMove} to answer</Badge> : undefined,
          },
        ]}
      />
      {!hasOrg ? (
        <EmptyState
          ...
          description="Create or join an organisation to list property or make offers."
          action={<LinkButton href="/onboarding">Set up an organisation</LinkButton>}
        />
      ) : tab === 'listings' ? (
        listings.length === 0 ? (
          <EmptyState
            ...
            action={
              canManage ? (
                <LinkButton href="/portal/listings/new">Create a listing</LinkButton>
              ) : undefined
            }
          />
        ) : (
          <DataTable
            ...
            columns={[
              ...
              },
              {
                key: 'updated',
                header: 'Updated',
                cell: (l) => formatDateLabel(l.updatedAt, zone),
                hideOnMobile: true,
              },
            ]}
          />
