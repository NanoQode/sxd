...
export default async function DataPoliciesPage() {
  ...
  const [items, rankEligible] = await Promise.all([
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Data policy settings"
        description="Publication and ranking rules that apply across all markets. Changes are audited and invalidate public caches."
      />
      <DataPoliciesEditor
        items={items}
        rankEligibleEvidence={rankEligible}
        canManage={
