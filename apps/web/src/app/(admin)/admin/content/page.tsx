        ...
        <DataTable
          ...
          columns={[
            ...
            },
            {
              key: 'kind',
              header: 'Kind',
              cell: (p) => <Badge tone="neutral">{humanize(p.kind)}</Badge>,
            },
            { key: 'status', header: 'Status', cell: (p) => <StatusBadge status={p.status} /> },
            {
              ...
              cell: (p) => (
                <span className="text-xs">
                  ...
                  {p.publishedRevision !== null && p.currentRevision > p.publishedRevision
                    ? ' · unpublished changes'
                    : ''}
                </span>
              ),
            },
            {
              key: 'publishAt',
              header: 'Scheduled',
              cell: (p) => (p.publishAt ? formatDateTimeLabel(p.publishAt) : '—'),
              hideOnMobile: true,
            },
