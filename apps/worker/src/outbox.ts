...
const routes: Record<string, OutboxRoute> = {
  ...
  // Listings, moderation and offers (apps/web/src/server/listings); the expiry
  // job is scheduled, so these events only fan out notifications.
  'listing.submitted': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing.published': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing.rejected': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing.changes_requested': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing.marked_duplicate': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing.expired': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing.inquiry_received': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing.outcome_recorded': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing_offer.submitted': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing_offer.countered': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing_offer.accepted': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing_offer.rejected': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing_offer.withdrawn': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
  'listing_offer.expired': () => [{ type: 'notifications.dispatch', queue: 'notifications' }],
